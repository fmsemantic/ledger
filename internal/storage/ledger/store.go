...
// before collecting N results (observed: ~50 s at prod-us-east-1-deriv v2.4.9).
...
type TransactionListConfig struct {
	...
	// before the upstream client disconnects (~50 s observed at Deriv).
	// Default 5000 ms.
...
// the table before accumulating N results — observed: ~50 s at Deriv.
